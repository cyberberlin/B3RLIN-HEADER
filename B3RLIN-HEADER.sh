...
local pid=$!
local delay=0.25
local spinner=( 'Berlin' 'bErlin' 'beRlin' 'berLin' 'berlIn' 'berliN' )
...
do
	tput civis
	echo -ne "\033[34m\r[*] Downloading..Shamayode kaathu nilk.........\e[33m[\033[32m$i\033[33m]\033[0m   ";
	sleep $delay
...
printf "   \b\b\b\b\b"
tput cnorm
printf "\e[1;33m [wokay sathanam open ayi]\e[0m";
echo "";
...
do
	echo ""
tput setaf 3
read -p "Ningalude peru adik : " PROC
tput sgr 0
if [ ${#PROC} -gt 8 ]; then
...
#echo -e '\033[1;43;30m### KERALA CYBER VAMPIRES ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
...
tput setaf 3
read -p  "Ith install akano vendayo ? (y/n) " PROC32
tput sgr 0
if [ "$PROC32" = "y" ]; then
...
clear;
echo -e "\033[31m$(figlet -f Remo773 "B3RLIN- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
B3RLIN : (\e[33m20.8.2020\e[32m)
...
\033[0m";
tput setaf 3;
read -p  "venamengil 'Y' adik makkale ? (y/n) " PROC33
...
then
	...
	echo -e "\e[1;34m[*] \033[32mNINGALK ENTE MANOHARAMAYA EE WORK ISTAMAYENU KARUTHUNNU.....\033[0m"
	exit
fi
exit 0
